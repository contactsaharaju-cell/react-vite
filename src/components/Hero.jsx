  ...
  <section id="home" className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 min-h-screen flex items-center justify-center hero-gradient overflow-hidden">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
      ...
      <p className="mt-6 max-w-2xl mx-auto text-lg md:text-xl text-gray-300">
        Join thousands of players in a world of endless entertainment, massive rewards, and non-stop excitement. Your winning journey starts now. (Designed by Raju Saha) v3.0.0
      </p>
      <div className="mt-10">
